angular.module('platen.services').factory('settings', ['storage',
  function(storage) {
    ...
    return {
      ...
      load: function(onCompletionCallback) {
        storage.get(LOCAL_STORAGE_SETTINGS_KEY, function(rawValue) {
      ...
      save: function(settings, onCompletionCallback) {
        storage.set(LOCAL_STORAGE_SETTINGS_KEY, settings, onCompletionCallback);
      }
    };
  }
]);