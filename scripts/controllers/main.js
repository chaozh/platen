var MainController = function($rootScope, $scope, $modal, $timeout, fileManager, logger, resources, settings) {
...
MainController.$inject = ['$rootScope', '$scope', '$modal', '$timeout', 'fileManager', 'logger', 'resources', 'settings'];
angular.module('platen.controllers').controller('MainController', MainController);
